...
export default function Cart() {
    const {state, dispatch}: {state: any, dispatch: any} = useContext(Context as any)
    const { cart } = state
    let total = 0
    ...
    <div className="mt-6">
      ...
      className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white">Checkout</a>
    </div>
    </div>
    )
}